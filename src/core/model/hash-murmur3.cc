                           ...
                           const uint32_t seed, void * out )
{
  ...
  switch(len & 15)
  {
  case 15: k2 ^= static_cast<uint64_t>(tail[14]) //PDB cast << 48;
  case 14: k2 ^= static_cast<uint64_t>(tail[13]) //PDB cast << 40;
  case 13: k2 ^= static_cast<uint64_t>(tail[12]) //PDB cast << 32;
  case 12: k2 ^= static_cast<uint64_t>(tail[11]) //PDB cast << 24;
  case 11: k2 ^= static_cast<uint64_t>(tail[10]) //PDB cast << 16;
  case 10: k2 ^= static_cast<uint64_t>(tail[ 9]) //PDB cast << 8;
  case  9: k2 ^= static_cast<uint64_t>(tail[ 8]) //PDB cast << 0;
           k2 *= c2; k2  = rotl64(k2,33); k2 *= c1; h2 ^= k2;

  case  8: k1 ^= static_cast<uint64_t>(tail[ 7]) //PDB cast << 56;
  case  7: k1 ^= static_cast<uint64_t>(tail[ 6]) //PDB cast << 48;
  case  6: k1 ^= static_cast<uint64_t>(tail[ 5]) //PDB cast << 40;
  case  5: k1 ^= static_cast<uint64_t>(tail[ 4]) //PDB cast << 32;
  case  4: k1 ^= static_cast<uint64_t>(tail[ 3]) //PDB cast << 24;
  case  3: k1 ^= static_cast<uint64_t>(tail[ 2]) //PDB cast << 16;
  case  2: k1 ^= static_cast<uint64_t>(tail[ 1]) //PDB cast << 8;
  case  1: k1 ^= static_cast<uint64_t>(tail[ 0]) //PDB cast << 0;
           k1 *= c1; k1  = rotl64(k1,31); k1 *= c2; h1 ^= k1;
  };
